    ...
    <div className='container'>
        ...
        <div className='about-top'>
          ...
          <span>
            ...
            Com mais de 1000 estudantes já passando por suas instalações, o cursinho tem se destacado por ajudar anualmente diversos alunos a ingressarem 
          ...
          <div className='about-fotos-1'>
            <div className='row'>
              <img src="" className='about-foto foto1'/>
              <img src="" className='about-foto foto2'/>
            </div>
            <img src="" className='about-foto foto3'/>
          </div>
          ...
          <div className='about-area'>
            ...
            <img src="" className='about-foto foto4'/>
            ...
            <img src="" className='about-foto foto5'/>
          ...
          <div className='equipe'>
            ...
            <CardArea color="red" title="Natureza" resume="O time que planta soluções e colhe resultados!"/>
